...
SECRET_KEY = "django-insecure-5&+(9lb2-e8m!udl_aakk3be@6lfx%+h@b8^n4%v(l-8e=w7r7"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "templates")],  # 📌 Cambiado a booking-app/templates
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [os.path.join(BASE_DIR, "static")]  # 📌 Cambiado a booking-app/static
